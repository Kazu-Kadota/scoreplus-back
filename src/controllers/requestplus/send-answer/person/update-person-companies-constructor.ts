...
export interface UpdatePersonCompaniesConstructorReturn {
  person_companies_analysis_constructor: PersonRegionType<CompaniesAnalysisContent> | undefined
...
const updatePersonCompaniesConstructor = (
  ...
  let person_companies_analysis_constructor: PersonRegionType<CompaniesAnalysisContent> | undefined
