...
export interface UpdatePersonCompaniesConstructorReturn {
  person_validated_analysis_constructor: PersonRegionType<PersonValidatedContent> | undefined
...
const updatePersonValidatedConstructor = (
  ...
  let person_validated_analysis_constructor: PersonRegionType<PersonValidatedContent> | undefined
