...
import { VehicleAnalysisConfig } from 'src/models/dynamo/request-vehicle'
import { VehicleRequestPlateHistoryAnalysis, VehicleRequestPlateHistoryForms } from 'src/models/dynamo/request-vehicle-plate-history'
...
const vehicle_schema = Joi.object<VehicleRequestPlateHistoryForms>({
  company_name: Joi
    .string()
    .max(255)
    .optional(),
...
const schema = Joi.object<VehicleRequestPlateHistoryAnalysis>({
...
const validateBodyVehiclePlateHistory = (
  data: Partial<VehicleRequestPlateHistoryAnalysis>,
): VehicleRequestPlateHistoryAnalysis => {
