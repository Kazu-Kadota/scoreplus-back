...
export type QueryRequestValidateVehicleByCompany = {
  start_date: string
  final_date: string
  company_name: string
}

export type QueryRequestValidateVehicleByCompanyResponse = {
  result: RequestplusValidateAnalysisVehicle[]
  last_evaluated_key?: Record<string, AttributeValue>
  count: number
}

const queryRequestplusValidateAnalysisVehicleByCompany = async (
  query: QueryRequestValidateVehicleByCompany,
  dynamodbClient: DynamoDBClient,
  last_evaluated_key?: Record<string, AttributeValue>,
): Promise<QueryRequestValidateVehicleByCompanyResponse | undefined> => {
  logger.debug({
...
export default queryRequestplusValidateAnalysisVehicleByCompany
