...
export type QueryRequestplusValidateAnalysisVehicleByIdQuery = {
  vehicle_id: string
}

const queryRequestplusValidateAnalysisVehicleById = async (
  query: QueryRequestplusValidateAnalysisVehicleByIdQuery,
...
export default queryRequestplusValidateAnalysisVehicleById
