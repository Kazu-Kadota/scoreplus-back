...
export type QueryRequestplusValidateAnalysisVehicleByPlateQuery = {
  plate: string
  plate_state: PlateStateEnum
  company_name?: string
}

const queryRequestplusValidateAnalysisVehicleByPlate = async (
  query: QueryRequestplusValidateAnalysisVehicleByPlateQuery,
...
export default queryRequestplusValidateAnalysisVehicleByPlate
