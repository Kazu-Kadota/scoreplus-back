...
import { VehicleRequestPlateHistory, VehicleRequestPlateHistoryBody } from 'src/models/dynamo/request-vehicle-plate-history'
import {
...
const putRequestVehiclePlateHistory = async (
  ...
  const put: VehicleRequestPlateHistory = {
    ...key,
    ...body,
    created_at: now,
    updated_at: now,
